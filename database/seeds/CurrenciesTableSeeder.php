...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
                        // 101
            [ "id" => "1", "country" => "المملكة العربية السعودية", "currency" => "الريال السعودي", "code" => "SAR", "symbol" => "﷼",
       ...
       // "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "2", "country" => "الولايات المتحدة الأمريكية", "currency" => "الدولار الامريكي", "code" => "USD", "symbol" => '$',
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
      ...
      //      [ "id" => "15", "country" => "Bosnia and Herzegovina", "currency" => "Convertible Marka", "code" => "BAM", "symbol" => "KM",
       ...
       //     "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
        ...
        //    "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "35", "country" => "مصر", "currency" => "الجنيه المصري", "code" => "EGP", "symbol" => "£",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
    ...
    //        [ "id" => "45", "country" => "Guatemala", "currency" => "Quetzales", "code" => "GTQ", "symbol" => "Q",
     ...
     //       "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
      ...
      //      "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "58", "country" => "فلسطين", "currency" => "الشيكل", "code" => "ILS", "symbol" => "₪",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
      ...
      //      "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "69", "country" => "لبنان", "currency" => "الليره اللبنانية", "code" => "LBP", "symbol" => "£",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
   ...
   //         [ "id" => "71", "country" => "Liechtenstein", "currency" => "Switzerland Francs", "code" => "CHF", "symbol" => "CHF",
    ...
    //        "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
     ...
     //       [ "id" => "77", "country" => "Mauritius", "currency" => "Rupees", "code" => "MUR", "symbol" => "₨",
      ...
      //      "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "90", "country" => "سلطنة عمان", "currency" => "الريال العماني", "code" => "OMR", "symbol" => "﷼",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
       ...
       //     "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "97", "country" => "قطر", "currency" => "الريال ", "code" => "QAR", "symbol" => "﷼",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
     ...
     //       [ "id" => "99", "country" => "Russia", "currency" => "Rubles", "code" => "RUB", "symbol" => "руб",
      ...
      //      "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            ...
            [ "id" => "102", "country" => "صربيا", "currency" => "الدينار", "code" => "RSD", "symbol" => "Дин.",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
     ...
     //       "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
      ...
      //      "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
       ...
       //     "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "115", "country" => "سوريا", "currency" => "الليرة السورية", "code" => "SYP", "symbol" => "£",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
     ...
     //       [ "id" => "118", "country" => "Trinidad and Tobago", "currency" => "Dollars", "code" => "TTD", "symbol" => "TT$",
      //      "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "119", "country" => "تركيا", "currency" => "الليرة التركي", "code" => "TRY", "symbol" => "TL",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
  ...
  //          [ "id" => "126", "country" => "Uzbekistan", "currency" => "Sums", "code" => "UZS", "symbol" => "лв",
   ...
   //         "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "130", "country" => "اليمن", "currency" => "الريال اليمني", "code" => "YER", "symbol" => "﷼",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
    //        [ "id" => "131", "country" => "Zimbabwe", "currency" => "Zimbabwe Dollars", "code" => "ZWD", "symbol" => "Z$",
    //        "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "132", "country" => "العراق", "currency" => "الدينار العراقي", "code" => "IQD", "symbol" => "د.ع",
            "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
  ...
  //          ["country" => "Algerie", "currency" => "Algerian dinar", "code" => "DZD", "symbol" => "د.ج", "thousand_separator" => " ", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "country" => "الامارات العربية المتحدة", "currency" => "الدرهم الاماراتي", "code" => "AED", "symbol" => "د.إ", "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
     ...
     //       [ "country" => "Angola", "currency" => "Kwanza", "code" => "AOA", "symbol" => "Kz", "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "country" => "الكويت", "currency" => "الدينار الكويتي", "code" => "KWD", "symbol" => "KD", "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "country" => "البحرين", "currency" => "الدينار البحريني", "code" => "BHD", "symbol" => "BD", "thousand_separator" => "", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ]
      ]);
    }
}
