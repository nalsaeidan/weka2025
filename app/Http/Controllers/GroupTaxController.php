    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    'action',
                    '<button data-href="{{action(\'GroupTaxController@edit\', [$id])}}" class="btn btn-xs btn-primary btn-modal" data-container=".tax_group_modal" title="@lang("messages.edit")"><i class="glyphicon glyphicon-edit"></i> </button>
                        &nbsp;
                        <button data-href="{{action(\'GroupTaxController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_tax_group_button" title="@lang("messages.delete")"><i class="glyphicon glyphicon-trash"></i></button>'
                )
