    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            if (!empty($start_date) && !empty($end_date)) {
                $stock_adjustments->where('transaction_date', '>=', $start_date)
            ...
            return Datatables::of($stock_adjustments)
                ->addColumn('action', '<button type="button" data-href="{{  action("StockAdjustmentController@show", [$id]) }}" class="btn btn-primary btn-xs btn-modal" data-container=".view_modal" title="@lang("messages.view")"><i class="fa fa-eye" aria-hidden="true"></i> </button>
                 &nbsp;
                    <button type="button" data-href="{{  action("StockAdjustmentController@destroy", [$id]) }}" class="btn btn-danger btn-xs delete_stock_adjustment ' . $hide . '" title=" @lang("messages.delete")"><i class="fa fa-trash" aria-hidden="true"></i></button>')
                ->removeColumn('id')
                ->editColumn(
                    'final_total',
