        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($users)
                ->addColumn(
                    'action',
                    '@can("user.update")
                    <button type="button" data-href="{{action(\'SalesCommissionAgentController@edit\', [$id])}}" data-container=".commission_agent_modal" class="btn btn-xs btn-modal btn-primary" title="@lang("messages.edit")"><i class="glyphicon glyphicon-edit"></i> </button>
                        &nbsp;
                        @endcan
                        @can("user.delete")
                        <button data-href="{{action(\'SalesCommissionAgentController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_commsn_agnt_button" title=" @lang("messages.delete")"><i class="glyphicon glyphicon-trash"></i></button>
                        @endcan'
                )
