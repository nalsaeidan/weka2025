...
//             $output = ['success' => 1, 'receipt' => []];
//             $output['receipt']['html_content'] = view('purchase.partials.purchaseInvoice', compact('taxes', 'purchase', 'payment_methods', 'purchase_order_nos', 'purchase_order_dates'))->render();
//         } catch (\Exception $e) {
//             \Log::emergency("File:" . $e->getFile(). "Line:" . $e->getLine(). "Message:" . $e->getMessage());
...
//     }
	...
	public function receiptContent($id)
    {
        // if (!auth()->user()->can('purchase.view')) {
        //     abort(403, 'Unauthorized action.');
        // }
        ...
        return view('purchase.partials.purchaseInvoice')
                ->with(compact('taxes', 'purchase', 'payment_methods', 'purchase_taxes', 'activities', 'statuses', 'purchase_order_nos', 'purchase_order_dates'));
    }
