    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($barcodes)
                ->addColumn(
                    'action',
                    '<a href="{{action(\'BarcodeController@edit\', [$id])}}" class="btn btn-xs btn-primary" title="@lang("messages.edit")"><i class="glyphicon glyphicon-edit"></i></a>
                        &nbsp;
                        <button type="button" data-href="{{action(\'BarcodeController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_barcode_button" @if($is_default) disabled @endif title="@lang("messages.delete")"><i class="glyphicon glyphicon-trash"></i> </button>&nbsp;
                        @if($is_default)
                            <button type="button" class="btn btn-xs btn-success" disabled title="@lang("barcode.default")"><i class="fas fa-check-square" aria-hidden="true"></i></button>
                        @else
                            <button class="btn btn-xs btn-info set_default" data-href="{{action(\'BarcodeController@setDefault\', [$id])}}" title="@lang("barcode.set_as_default")"><i class="fas fa-cog"></i></button>
                        @endif
                        '
                )
