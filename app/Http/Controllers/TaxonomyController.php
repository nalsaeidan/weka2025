        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($category)
                ->addColumn(
                    'action',
                    '
                    <button data-href="{{action(\'TaxonomyController@edit\', [$id])}}?type=' . $category_type . '" class="btn btn-xs btn-primary edit_category_button" title="@lang("messages.edit")"><i class="glyphicon glyphicon-edit"></i></button>
                        &nbsp;
                    
                        <button data-href="{{action(\'TaxonomyController@destroy\', [$id])}}" class="btn btn-xs btn-danger delete_category_button" title="@lang("messages.delete")"><i class="glyphicon glyphicon-trash"></i> </button>
                    '
                )
