...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        InvoiceLayout::create(['name' => 'Default',
                        ...
                        'invoice_heading' => 'الفاتورة',
                        'sub_total_label' => 'الاجمالي الفرعي',
                        ...
                        'total_due_label' => 'الاجمالي مستحق الدفع',
                        'paid_label' => 'الاجمالي المدفوع',
                        'show_payments' => 1,
                        'show_customer' => 1,
                        ...
                        'table_subtotal_label' => 'المجموع الفرعي',
                        'date_label' => 'التاريخ'
                    ]);
