...
class ProductUtil extends Util
{
    ...
    public function getDetailsFromVariation($variation_id, $business_id, $location_id = null, $check_qty = true)
    {
        ...
        $product = $query->select(
            ...
            'p.barcode_type',
            'vld.qty_available',
        	DB::raw('SUM(vld.qty_available) as current_stock'),          //المخزون الحالي
            'variations.default_sell_price',
        	'variations.default_purchase_price',  //سعر شراء الوجدة بدون ضريبة
            'variations.sell_price_inc_tax',
            'variations.dpp_inc_tax',   //سعر شراء الوجدة مع ضريبة    
