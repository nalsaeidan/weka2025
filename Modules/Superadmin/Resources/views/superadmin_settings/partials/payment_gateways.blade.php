<div class="pos-tab-content">
 ...
 <h4>MyFatoorah:</h4>
  	...
  	<div class="col-xs-4">
            <div class="form-group">
            	{!! Form::label('FATOORAH_BASE_URL', __('superadmin::lang.FATOORAH_BASE_URL') . ':') !!}
            	{!! Form::text('FATOORAH_BASE_URL', $default_values['FATOORAH_BASE_URL'], ['class' => 'form-control','placeholder' => __('superadmin::lang.FATOORAH_BASE_URL')]); !!}
            </div>
        </div>
 
   	<div class="col-xs-4">
            <div class="form-group">
            	{!! Form::label('FATOORAH_TOKEN', __('superadmin::lang.FATOORAH_TOKEN') . ':') !!}
            	{!! Form::text('FATOORAH_TOKEN', $default_values['FATOORAH_TOKEN'], ['class' => 'form-control','placeholder' => __('superadmin::lang.FATOORAH_TOKEN')]); !!}
            </div>
        </div>
