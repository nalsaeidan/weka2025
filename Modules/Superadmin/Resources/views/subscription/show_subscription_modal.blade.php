          ...
          <table class="table subscription-details">
            ...
            <body>
              <tr>
                ...
                <td><span class="display_currency" data-currency_symbol="true">{{ ($subscription->package_price - ($subscription->package_price / ( ($subscription->package->tax_p / 100) +1 ) ) ) }}</span> </td>
              </tr>
            </body>
          </table>
        </div>
