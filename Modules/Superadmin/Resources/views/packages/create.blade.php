	...
	<div class="box box-solid">
		<div class="box-body">
			<div class="row">
            	...
            	<div class="col-sm-6">
					<div class="form-group">
						{!! Form::label('tax_p', "الضريبة".':') !!}
						@show_tooltip(__('superadmin::lang.tooltip_pkg_price'))

						<div class="input-group">
							<span class="input-group-addon" id="basic-addon3"><b>%</b></span>
							{!! Form::text('tax_p', null, ['class' => 'form-control input_number', 'required','min' => 0]); !!}
						</div>
				...
				<div class="col-sm-6">
					<div class="form-group">
						{!! Form::label('price_befor', "السعر قبل الخصم".':') !!}
						@show_tooltip(__('superadmin::lang.tooltip_pkg_price'))


						<div class="input-group">
							<span class="input-group-addon" id="basic-addon3"><b>{{$currency->code}} {{$currency->symbol}}</b></span>
							{!! Form::text('price_befor', null, ['class' => 'form-control input_number', 'required','min' => 0]); !!}
						</div>
