...
class PackagesController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['name', 'description', 'location_count', 'user_count', 'product_count', 'invoice_count', 'interval', 'interval_count', 'trial_days', 'tax_p', 'price_befor', 'price', 'sort_order', 'is_active', 'custom_permissions', 'is_private', 'is_one_time', 'enable_custom_link', 'custom_link',
                'custom_link_text']);

            $currency = System::getCurrency();
            $input['tax_p'] = $this->businessUtil->num_uf($input['tax_p'], $currency);
			$input['price_befor'] = $this->businessUtil->num_uf($input['price_befor'], $currency);
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $packages_details = $request->only(['name', 'id', 'description', 'location_count', 'user_count', 'product_count', 'invoice_count', 'interval', 'interval_count', 'trial_days','tax_p','price_befor', 'price', 'sort_order', 'is_active', 'custom_permissions', 'is_private', 'is_one_time', 'enable_custom_link', 'custom_link', 'custom_link_text']);
