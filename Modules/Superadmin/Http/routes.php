...
Route::group(['middleware' => ['web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu'],
    'namespace' => 'Modules\Superadmin\Http\Controllers'], function () {
        ...
        Route::get('/subscription/{package_id}/subscripe', 'SubscriptionController@subscription')->name('subscripe.package');
        Route::get('/subscription/confirm-payment', 'SubscriptionController@confirmPayment')->name('subscripe.package.confirm');
