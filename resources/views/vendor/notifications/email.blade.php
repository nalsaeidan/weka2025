...
<head>
    ...
    <style>
        body {
            font-family: 'Tahoma', 'Arial', sans-serif; /* تغيير الخطوط إلى تاهوما أو الخطوط الاحترافية الأخرى */
            direction: rtl;
            text-align: right;
        ...
        .header h1 {
            color: #2d3748;
            font-size: 26px;
            font-family: 'Tahoma', sans-serif; /* تغيير خط العنوان */
        }
        .content {
            padding: 20px;
            font-size: 16px;
...
<p style="margin: 10px 0;">© {{ date('Y') }} نظام وِكاء المحاسبي. جميع الحقوق محفوظة.</p>
        </div>
    </div>
</body>
</html>
