              ...
              {!! Form::open(['url' => action('ReportController@getStockReport'), 'method' => 'get', 'id' => 'sales_representative_filter_form' ]) !!}
               ...
               <div class="col-md-12">
                ...
                <div class="col-md-3">
                    ...
                    @endphp
                    <div class="form-group">
                        {!! Form::text('start_time', @format_time($startDay), ['style' => __('lang_v1.select_a_date_range'), 'class' => 'form-control width-50 f-left', 'id' => 'sr_start_time']); !!}
                        {!! Form::text('end_time', @format_time($endDay), ['class' => 'form-control width-50 f-left', 'id' => 'sr_end_time']); !!}
                    </div>
                </div>
...
@section('javascript')
    <script src="{{ asset('js/report.js?v=14' . $asset_v) }}"></script>
