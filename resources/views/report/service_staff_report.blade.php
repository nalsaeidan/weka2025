    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.filters', ['title' => __('report.filters')])
                ...
                <div class="col-md-3">
                    {!! Form::label('ssr_start_time', __('lang_v1.time_range') . ':') !!}
                    ...
                    @endphp
                    <div class="form-group">
                        {!! Form::text('start_time', @format_time($startDay), ['style' => __('lang_v1.select_a_date_range'), 'class' => 'form-control width-50 f-left', 'id' => 'ssr_start_time']); !!}
                        {!! Form::text('end_time', @format_time($endDay), ['class' => 'form-control width-50 f-left', 'id' => 'ssr_end_time']); !!}
                    </div>
                </div>
                {!! Form::close() !!}
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            if($('#ssr_date_range').length == 1){
                ...
                $('#ssr_start_time, #ssr_end_time').datetimepicker({
