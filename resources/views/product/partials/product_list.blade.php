...
<div class="table-responsive" style="overflow-x: visible;">
    <table class="table table-bordered table-striped ajax_view hide-footer" id="product_table" style="width:100% !important;">
        <thead>
            <tr>
            	<th width="5%"></th>
                ...
                <div style="display: flex; width: 100%;">
                    ...
                    @endcan
                        ...
                        @can('product.update')
                            ...
                            @endif
                            &nbsp;
                            <button type="button" class="btn btn-xs btn-success update_product_location" data-type="add">اضافة الى الموقع</button>
                            &nbsp;
                            <button type="button" class="btn btn-xs bg-navy update_product_location" data-type="remove">حذف من الموقع</button>
                        @endcan
                    
                    &nbsp;
                    {!! Form::open(['url' => action('ProductController@massDeactivate'), 'method' => 'post', 'id' => 'mass_deactivate_form' ]) !!}
                    {!! Form::hidden('selected_products', null, ['id' => 'selected_products']); !!}
                    {!! Form::submit("تعطيل", array('class' => 'btn btn-xs btn-warning', 'id' => 'deactivate-selected')) !!}
