...
<div class="row">
	<div class="col-sm-12 pos_product_div">
        ...
        <style>
        #pos_table thead th.text-center.hidden_pos {
    		display: none;
			}
		#pos_table tbody tr.product_row td:nth-child(3), #pos_table tbody tr.product_row td:nth-child(4) {
    		display: none;
			}
        </style>
			<thead>
				<tr>
        			...
        			<!-- من هنا --!>
					@if (auth::user()->id == $business_details['owner_id'])
						
					
						<th class="text-center hidden_pos">
							سعر الشراء
						</th>
						<th class="text-center hidden_pos">
							المخزون
