<table style="width:100%; margin-top:45px !important; direction:rtl !important">
	...
	<tbody>
		<tr>
			<td style="text-align:left !important ;line-height: 15px !important; padding-bottom: 10px !important">
...
<div class="row invoice-info">
	...
	<div class="col-md-6 invoice-col width-50" style="margin-top:0px !important">

		<div class="font-20 color-555" style="text-align:left !important ;">
			@if(!empty($receipt_details->invoice_no_prefix))
		...
		@if(!empty($receipt_details->total_due))
			<div class="bg-light-blue-active font-20 padding-5" style="text-align:left !important ;margin:10px !important;font-weight: bold !important; color:black !important">
		...
		@if(!empty($receipt_details->all_due))
			<div class="bg-light-blue-active font-20 padding-5" style="text-align:left !important ;">
				<span class="text-right bg-light-blue-active">
	...
	<div class="col-md-6 invoice-col width-50 color-555" style="margin-top: 40px;">
		
		<!-- Logo -->
		@if(!empty($receipt_details->logo))
			<img style="margin-top: -70px; max-height: 120px; width: auto;" src="{{$receipt_details->logo}}">
			<br/>
		@endif
...
<div class="row invoice-info color-555 text-right" style="page-break-inside: avoid !important">
	<div class="col-md-6 invoice-col width-50">
		<table class="table table-slim" style="text-align:left !important ;">
    ...
    <b style="margin-top:10px; float: left!important;">@lang('lang_v1.authorized_signatory')</b>
	</div>
</div>
