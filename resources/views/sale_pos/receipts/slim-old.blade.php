...
<!--             	@if(!empty($receipt_details->contact) && !empty($receipt_details->website))
        	...
        	<div class=" textbox-info">
				<p class="" style="font-weight:bold; float: right; text-align: right;"><strong>{!! $receipt_details->invoice_no_prefix !!}</strong></p>
    ...
    @if(!empty($receipt_details->customer_tax_label))
        ...
        <table class="table table-bordered border-bottom width-100 table-f-12 mb-10" style="padding-top: 5px !important; direction: rtl !important;">
            <thead>
            <!-- <th>#</th> -->
...
<!--         {{dd($receipt_details)}} -->
				<br/>
                   <img class="center-block" style="width:100px !important" src="data:image/png;base64,{{DNS2D::getBarcodePNG(qrcodee([1,2,3,4,5],[$receipt_details->display_name,$receipt_details->tax_info1,$receipt_details->invoice_date,$receipt_details->total1,$receipt_details->tax1+$total_row_tax]), 'QRCODE')}}" alt="barcode"/>
