...
<section class="content">
    @component('components.widget', ['class' => 'box-primary', 'title' => __( 'tax_rate.all_your_tax_rates' )])
        ...
        @can('tax_rate.view')
            <div class="table-responsive" style="overflow-x: visible;">
                <table class="table table-bordered table-striped" id="tax_rates_table" style="width: 100% !important;">
                    <thead>
                        <tr>
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        @can('tax_rate.view')
            <div class="table-responsive" style="overflow-x: visible;">
                <table class="table table-bordered table-striped" id="tax_groups_table" style="width: 100% !important;">
                    <thead>
                        <tr>
                        	<th width="5%"></th>
                            <th>@lang( 'tax_rate.name' )</th>
