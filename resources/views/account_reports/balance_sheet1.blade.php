...
<section class="content-header">
    ...
    <h1 class="content-header" >دفتر الحسابات
    </h1>
</div>
    <div class="row">
...
<section class="content">
    ...
    <br>
    <div hidden class="box box-solid">
...
// for table 
                $('td#start_debits').text(__currency_trans_from_en(result.start_debits, true));
                __write_number($('input#hidden_start_debits'));
