...
<div hidden class="col-md-6">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::select('time_zone', $timezone_list, config('app.timezone'), ['class' => 'form-control select2_register','placeholder' => __('business.time_zone')]); !!}
        </div>
    </div>
</div>
{{-- <div class="clearfix"></div> --}}
...
<!-- tax details -->
{{-- @if(empty($is_admin))
    <h3 hidden>@lang('business.business_settings')</h3>
...
<div class="form-group col-md-4">
    ...
    <div class="input-group">
        ...
        {!! Form::number('contact_number', null, ['class' => 'form-control', 'placeholder' => __( 'lang_v1.mobile_number') ]); !!}
    </div>
</div>
<div class="clearfix"></div>
<div class="col-md-6">
...
<div class="col-md-6">
    <div class="form-group">
        ...
        <div class="g-recaptcha" data-sitekey="{{ env('CAPTCHA_KEY') }}">
            ...
            @endif
		{{-- حساب البرو pro --}}
        {{-- <div class="g-recaptcha" data-sitekey="6Leb6_YcAAAAALz5bf8g-5lZwVO9LDcNTS1BvWrW"> --}}
    	</div>
    </div>
</div>
