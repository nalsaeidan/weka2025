...
<div class="table-responsive" style="overflow-x: visible;">
        <table class="table table-bordered table-striped ajax_view" id="purchase_order_table" style="width: 100% !important;">
            <thead>
                <tr>
                	<th width="5%"></th>
...
<script type="text/javascript">
  ...
  $('table#purchase_order_table>tbody').on('click', 'td.details-control', function () {
$('table#purchase_order_table>tbody>tr').removeAttr('data-href');

        var tr = $(this).closest('tr');
        var row = purchase_order_table.row( tr );
