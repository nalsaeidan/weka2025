...
<script>
    ...
    $('table#sell_return_table>tbody').on('click', 'td.details-control', function () {
	$('table#sell_return_table>tbody>tr').removeAttr('data-href');

        var tr = $(this).closest('tr');
        var row = sell_return_table.row( 'tr' );
