...
<script>
    ...
    $('table#purchase_return_datatable>tbody').on('click', 'td.details-control', function () {
$('table#purchase_return_datatable>tbody>tr').removeAttr('data-href');

        var tr = $(this).closest('tr');
        var row = purchase_return_table.row( tr );
