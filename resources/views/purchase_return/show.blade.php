<div class="modal-dialog modal-xl" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="col-6 col-md-6 col-sm-6 col-xs-6 text-left" style="padding:20px">
        ...
        <div class="col-6 col-md-6 col-sm-6 col-xs-6 text-right" style="padding:20px">
  ...
  <!--  <div class="row">
    <div class="" style="text-align:right!important; float:right !important; width:50%">
     @if(!empty($purchase->business->logo))
    <img style="max-height: 120px; width: auto;" src="{{asset('uploads/invoice_logos/'. $purchase->business->logo)}}" class="img">
    @endif
    <h3>شركة النصر</h3>
    <p>السعودية-الرياض</p>
    <p>vat123456</p>
    ...
    <div class="" style="text-align:left!important; float:left !important; width:50%">
    <h1><b>الاشعار الدائن</b></h1><br>
    <p> رقم الاشعار الدائن 31200225</p>
    <p><b> الائتمانات المتبقية</b> </p><br/> <p>1200</p>
      <p><b>تاريخ الائتمان</b> {{ @format_date($purchase->transaction_date) }}</p>
    
      <p><b>رقم الفاتورة</b> 2027</p>
    
      <p><b>تاريخ الفاتورة</b> {{ @format_date($purchase->transaction_date) }}</p>
    </div>
  ...
  @endif
    <div class="row">
    <p class="p-5 pull-right"> @lang('lang_v1.authorized_signatory')</p>
      <!--<div class="col-md-12">
            <strong>{{ __('lang_v1.activities') }}:</strong><br>
