<?php
return [
"added_success" => "تم اضافة الحساب بنجاح",
"accounts_update_success" => "تم تعديل الحساب بنجاح",
"account" => "الحسابات",
"account_menu" => " دليل الحسابات ",
"restrict_menu" => "القيود",
...
"closed" => "مغلق",
"add_new_account"=>"اضافه حساب جديد",
